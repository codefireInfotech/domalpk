...
class KGlassCostPSFComponent extends StatelessWidget {
  const KGlassCostPSFComponent({Key? key}) : super(key: key);
            ...
            children: [
              ...
              Expanded(
                child: Container(
                  ...
                  child: TextFormField(
                    onChanged: (val) {
                      _provider.setGlassCostPerSquareFeet(val);
                    },
                    validator: (val) {
